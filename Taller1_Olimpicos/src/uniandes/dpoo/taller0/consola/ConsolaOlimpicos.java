...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el nombre del País que representa el atleta");
	 ...
	 * busca al atleta y le informa al usuario el Pais que representa
	 */
	private String ejecutarPaisRepresentadoAtleta()
	{
		System.out.println("\n" + "País que representa un atleta" + "\n");
		
		String name = input ("Por favor ingrese el nombre de un atleta");
		String paisatleta = calculadora.PaisRepresentadoAtleta(name);
		
		System.out.println("\nEl atleta " + name + " representa al país: " + paisatleta);
		return paisatleta;
	}
